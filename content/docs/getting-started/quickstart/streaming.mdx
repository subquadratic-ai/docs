...
- An Aldea API key. Sign up and generate one from the [API Keys page](/docs/getting-started/get-api-key).
...
You can control endpointing sensitivity, enable PII redaction, set the transcription language, and more by adding query parameters to the WebSocket URL. See the full [streaming API reference](/docs/api-reference/streaming) for all available options.
