...
wss://api.subquadratic.ai/v1/listen?redact=pii&encoding=mp3

# Redact payment card data
wss://api.subquadratic.ai/v1/listen?redact=pci&encoding=mp3

# Combine multiple redaction types
wss://api.subquadratic.ai/v1/listen?redact=pii&redact=pci&encoding=mp3

# Redact all supported types
wss://api.subquadratic.ai/v1/listen?redact=true&encoding=mp3
```
...
wss://api.subquadratic.ai/v1/listen?redact=pii&redact_mode=replace&encoding=mp3
```
