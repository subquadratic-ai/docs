...
- A **SubQ API key** - if you don't have one yet, follow [Step 1: Get your API key](/docs/getting-started/quickstart/pre-recorded#step-1-get-your-api-key) in the quickstart
