...
If you already use Deepgram, switch to SubQ by updating your API key and base URL. All existing Deepgram SDKs (Python, Node.js, Go, Rust, .NET) work out of the box.

### Use SubQ mobile SDKs
