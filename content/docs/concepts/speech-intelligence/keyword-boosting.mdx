...
```bash
curl -X POST "https://api.subquadratic.ai/v1/listen?keywords=SubQ&keywords=STT" \
...
```bash
wss://api.subquadratic.ai/v1/listen?keywords=SubQ&keywords=STT&interim_results=true
```
