...
| | Deepgram | SubQ |
|---|---|---|
| REST base URL | `https://api.deepgram.com` | `https://stt-api.subq.ai` |
| WebSocket URL | `wss://api.deepgram.com` | `wss://stt-api.subq.ai` |
...
Sign up at [speech.subq.ai](https://speech.subq.ai) and generate an API key from the [API Keys page](/docs/getting-started/get-api-key). Your key starts with `org_`.
...
| Error | Fix |
|-------|-----|
| Connection refused | Verify the base URL is `https://stt-api.subq.ai` |
