...
| Endpoint | Accepts |
|----------|---------|
| `wss://api.subquadratic.ai/v1/listen` | Encoded audio (MP3, AAC, FLAC, WAV, OGG, WebM, Opus, M4A) and raw PCM |
| `wss://api.subquadratic.ai/v1/listen/pcm` | Raw PCM only (optimized for low-latency PCM streams) |
