...
Sign up at [platform.subquadratic.ai](https://platform.subquadratic.ai) and generate an API key from the [API Keys page](/docs/getting-started/get-api-key). Your key starts with `org_`.
